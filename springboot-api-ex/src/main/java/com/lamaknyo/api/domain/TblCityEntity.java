...
@Entity
@Table(name = "tbl_city", schema = "lamaknyo_dabe", catalog = "")
public class TblCityEntity {
    private int citId;
    private Integer citCnyId;
    private int citRegId;
    ...
    @Basic
    @Column(name = "cit_reg_id", nullable = false)
    public int getCitRegId() {
        return citRegId;
    }

    public void setCitRegId(int citRegId) {
        this.citRegId = citRegId;
    }
    ...
    @Basic
    @Column(name = "cit_name", nullable = true, length = 100)
    ...
    public boolean equals(Object o) {
        ...
        TblCityEntity that = (TblCityEntity) o;
        return citId == that.citId &&
                citRegId == that.citRegId &&
                ...
                Objects.equals(citName, that.citName) &&
